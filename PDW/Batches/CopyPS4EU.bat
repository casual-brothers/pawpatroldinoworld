...
copy /Y %~dp0..\Platforms\PS4\Config\PS4Engine_EU.ini %~dp0..\Platforms\PS4\Config\PS4Engine.ini 
copy /Y %~dp0..\Platforms\PS4\Config\PS4Game_EU.ini %~dp0..\Platforms\PS4\Config\PS4Game.ini 
