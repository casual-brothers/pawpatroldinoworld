...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FFlowTriggerComponentEvent, const bool, bOverlapping, class UFlowComponent*, OtherFlowComponent, UFlowComponent*, SourceFlowComponent);
