...
USTRUCT()
struct FFlowNodeContainer
{
	GENERATED_BODY()
	UPROPERTY(EditAnywhere)
	TArray<TSoftClassPtr<class UFlowNode>> Nodes;
};
...
class FLOWEDITOR_API UFlowGraphSettings : public UDeveloperSettings
{
	...
	* Requires restart after making a change. */
	...
	UPROPERTY(EditAnywhere, config, Category = "Nodes", meta = (ConfigRestartRequired = true, ForceInlineRow))
	TMap<TSoftClassPtr<class UFlowAsset>, FFlowNodeContainer> NodesHiddenFromSpecificPalette;
