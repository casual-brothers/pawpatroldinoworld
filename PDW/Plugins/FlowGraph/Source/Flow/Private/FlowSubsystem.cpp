...
void UFlowSubsystem::StartRootFlow(UFlowComponent* Owner, UFlowAsset* FlowAsset, const bool bAllowMultipleInstances /* = true */)
{
	if (FlowAsset)
	{
...
UFlowAsset* UFlowSubsystem::CreateSubFlow(UFlowNode_SubGraph* SubGraphNode, const FString& SavedInstanceName, const bool bPreloading /* = false */)
{
	...
	{
		StartSubFlow(SubGraphNode, SavedInstanceName);
	}

	return NewInstance;
}

void UFlowSubsystem::StartSubFlow(UFlowNode_SubGraph* SubGraphNode, const FString& SavedInstanceName)
{
...
void UFlowSubsystem::LoadRootFlow(UObject* Owner, UFlowAsset* FlowAsset, const FString& SavedAssetInstanceName, const bool bAllowMultipleInstances /* = true */)
{
