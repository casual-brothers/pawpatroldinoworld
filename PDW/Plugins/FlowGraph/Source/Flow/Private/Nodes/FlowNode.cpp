...
void UFlowNode::ForceSignalMode(EFlowSignalMode NewMode)
{
	SignalMode = NewMode;
}

void UFlowNode::SetCheatMode(bool UsingCheat)
{
	CheatMode = UsingCheat;
}
...
{
	if (SignalMode == EFlowSignalMode::PassThrough && !CheatMode)
	{
