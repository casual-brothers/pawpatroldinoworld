...
public:
	...
	virtual void StartRootFlow(UFlowComponent* Owner, UFlowAsset* FlowAsset, const bool bAllowMultipleInstances = true);
...
public:	
	...
	void StartSubFlow(UFlowNode_SubGraph* SubGraphNode, const FString& SavedInstanceName = FString());
...
// SaveGame support
	...
	UFUNCTION(BlueprintCallable, Category = "FlowSubsystem")
	virtual void LoadRootFlow(UObject* Owner, UFlowAsset* FlowAsset, const FString& SavedAssetInstanceName, const bool bAllowMultipleInstances = false);
